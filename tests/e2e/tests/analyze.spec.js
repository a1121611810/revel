...
test.describe('AnalyzeView E2E', () => {
  ...
  test('should navigate to analyze view', async () => {
    ...
    await window.locator('text=分析').click()
    await window.waitForTimeout(500)

    await expect(window.getByRole('heading', { name: '分析' })).toBeVisible()
  })
})
