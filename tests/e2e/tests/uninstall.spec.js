...
test.describe('UninstallView E2E', () => {
  let electronApp
  ...
  test('should navigate to uninstall view', async () => {
    ...
    await window.locator('text=卸载').click()
    await window.waitForTimeout(500)

    await expect(window.getByRole('heading', { name: '卸载' })).toBeVisible()
  })
})
